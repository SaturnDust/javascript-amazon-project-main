...
updateTotalQty();
  ...
  cart.forEach((cartItem) => {
      ...
      cartSummaryHTML += `
      <div class="cart-item-container js-cart-item-container-${productQuery.id}">
            ...
            <div class="cart-item-details-grid">
              ...
              <div class="cart-item-details">
                ...
                <div class="product-quantity">
                  ...
                  <span class="update-quantity-link link-primary js-update-link" data-product-id = "${productQuery.id}">
                    Update
                  </span>
                  <input class="quantity-input" id="${productQuery.id}"></input>
                  <span class="save-quantity-link link-primary js-save-link" data-product-id = "${productQuery.id}">Save</span>
                  <span class="delete-quantity-link link-primary js-delete-link" data-product-id = "${productQuery.id}"> 
                    Delete
                  </span>
                </div>
              </div>
              ...
              <div class="delivery-options">
                ...
                <div class="delivery-option">
                  <input type="radio" checked class="delivery-option-input" name="delivery-option-${productQuery.id}">
                  <div>
                ...
                <div class="delivery-option">
                  <input type="radio" class="delivery-option-input" name="delivery-option-${productQuery.id}">
                  <div>
                    <div class="delivery-option-date">
                      Wednesday, June 15
                    </div>
